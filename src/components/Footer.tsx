...
function Footer({ isVisible }: { isVisible: boolean }) {
  return (
    <footer className={`${isVisible ? 'hidden' : "visible "} row-end-13  col-start-3 col-end-13 bg-gray-800 text-white py-4 pb-4`}>
      <div className="container mx-auto text-center flex gap-2 justify-center">
