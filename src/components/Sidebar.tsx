...
function Sidebar({ isVisible}: { isVisible: boolean, }) {
  ...
  return (
    <aside
      ...
      className={`${
        isVisible && "hidden"
      } bg-green-500 row-span-full row-start-2 col-span-2 h-full`}
      aria-label="Sidebar"
    >
      <div className="h-full px-3 py-4 overflow-y-auto bg-sky-700 ">
        <ul className="space-y-2 font-medium">
          <li>
            ...
            >
              <svg
                className="w-5 h-5  transition duration-75  group-hover: group-hover:text-white"
                aria-hidden="true"
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Cabang</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              {/* <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full bg-blue-900 text-blue-300">
                3
              </span> */}
            </Link>
          </li>
          ...
          <li className="hover:cursor-pointer">
            ...
            <div className="h-5 w-5 relative">
              <Image src={logout} objectFit="cover" alt="logout" />
            </div>
